...
namespace Fluid
{
	...
	namespace Computation
	{
		...
		void Advect(int i_n, int i_m, float i_deltaTime, float *i_ux, float* i_uy, float* o_ux, float* o_uy);
		...
		/*void SetBoundry(int i_n, int i_m, float* o_ux, float* o_uy);
		void SetBoundry(int i_n, int i_m, float* o_v);*/
